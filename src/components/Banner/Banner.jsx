            ...
            <div className="hero  mt-14 rounded-lg bg-img"  >
                <div className="hero-content text-center text-neutral-content">
                    <div className="mx-auto text-center ">
                        ...
                        <a href="#"><button
                            className="btn bg-[#0BE58A] px-[25px] text-[#150B2B] rounded-3xl  font-semibold  mr-6 hover:bg-transparent hover:border-[#FF4240] hover:text-white mt-10 text-xl ">Explore Now</button></a>
                        <a href="#"><button
                            className="btn bg-transparent btn-outline px-[25px] text-[#FFF] rounded-3xl  font-semibold  mr-6 hover:bg-[#0BE58A] hover:border-[#FF4240] hover:text-[#150B2B]  mt-10 text-xl ">Our Feedback</button></a>
